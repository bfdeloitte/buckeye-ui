...
describe('<bui-breadcrumb-item>', () => {
  let el: BreadcrumbItem;

  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<BreadcrumbItem>(html` <bui-breadcrumb-item>Home</bui-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<BreadcrumbItem>(html`
          <bui-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</bui-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<BreadcrumbItem>(html`
          <bui-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</bui-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<BreadcrumbItem>(html`
          <bui-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</bui-breadcrumb-item
          >
        `);
      });
