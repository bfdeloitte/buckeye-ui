...
describe('<bui-tag>', () => {
  it('should render default tag', async () => {
    const el = await fixture<Tag>(html` <bui-tag>Test</bui-tag> `);
  ...
  it('should set variant by attribute', async () => {
    const el = await fixture<Tag>(html` <bui-tag variant="danger">Test</bui-tag> `);
  ...
  it('should set size by attribute', async () => {
    const el = await fixture<Tag>(html` <bui-tag size="large">Test</bui-tag> `);
  ...
  it('should set pill-attribute by attribute', async () => {
    const el = await fixture<Tag>(html` <bui-tag pill>Test</bui-tag> `);
  ...
  it('should set removable by attribute', async () => {
    const el = await fixture<Tag>(html` <bui-tag removable>Test</bui-tag> `);
  ...
  describe('removable', () => {
    it('should emit remove event when remove button clicked', async () => {
      ...
      el.addEventListener('bui-remove', spy, { once: true });
