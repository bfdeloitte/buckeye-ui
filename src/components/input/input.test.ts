...
describe('<bui-input>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<Input>(html` <bui-input label="Name"></bui-input> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<Input>(html` <bui-input></bui-input> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<Input>(html` <bui-input title="Test"></bui-input> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<Input>(html` <bui-input disabled></bui-input> `);
    const input = el.shadowRoot!.querySelector<HTMLInputElement>('[part~="input"]')!;
  ...
  describe('value methods', () => {
    it('should set the value as a date when using valueAsDate', async () => {
      const el = await fixture<Input>(html` <bui-input type="date"></bui-input> `);
    ...
    it('should set the value as a number when using valueAsNumber', async () => {
      const el = await fixture<Input>(html` <bui-input type="number"></bui-input> `);
      const num = 12345;
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<Input>(html` <bui-input required></bui-input> `);
      expect(el.reportValidity()).to.be.false;
      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and disabled is removed', async () => {
      const el = await fixture<Input>(html` <bui-input disabled required></bui-input> `);
      el.disabled = false;
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<Input>(html` <bui-input required value="a"></bui-input> `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><bui-input required></bui-input></form> `);
      const input = el.querySelector<Input>('bui-input')!;
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><bui-input name="a" value="1"></bui-input></form> `);
    ...
    it('should submit the form when pressing enter in a form without a submit button', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><bui-input></bui-input></form> `);
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const input = await fixture<HTMLFormElement>(html` <bui-input></bui-input> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <bui-input form="f" name="a" value="1"></bui-input>
        </div>
      `);
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <bui-input name="a" value="test"></bui-input>
  ...
  describe('when calling HTMLFormElement.reportValidity()', () => {
    it('should be invalid when the input is empty and form.reportValidity() is called', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <bui-input required value=""></bui-input>
          <bui-button type="submit">Submit</bui-button>
        </form>
      `);
  ...
  describe('when the value changes', () => {
    it('should emit bui-change and bui-input when the user types in the input', async () => {
      const el = await fixture<Input>(html` <bui-input></bui-input> `);
    ...
    it('should not emit bui-change or bui-input when the value is set programmatically', async () => {
      const el = await fixture<Input>(html` <bui-input></bui-input> `);
    ...
    it('should not emit bui-change or bui-input when calling setRangeText()', async () => {
      const el = await fixture<Input>(html` <bui-input value="hi there"></bui-input> `);
  ...
  describe('when type="number"', () => {
    it('should be valid when the value is within the boundary of a step', async () => {
      const el = await fixture<Input>(html` <bui-input type="number" step=".5" value="1.5"></bui-input> `);
      expect(el.checkValidity()).to.be.true;
    });

    it('should be invalid when the value is not within the boundary of a step', async () => {
      const el = await fixture<Input>(html` <bui-input type="number" step=".5" value="1.25"></bui-input> `);
      expect(el.checkValidity()).to.be.false;
    });
    ...
    it('should increment by step when stepUp() is called', async () => {
      const el = await fixture<Input>(html` <bui-input type="number" step="2" value="2"></bui-input> `);
    ...
    it('should not emit bui-input or bui-change when stepUp() is called programmatically', async () => {
      const el = await fixture<Input>(html` <bui-input type="number" step="2" value="2"></bui-input> `);
    ...
    it('should not emit bui-input and bui-change when stepDown() is called programmatically', async () => {
      const el = await fixture<Input>(html` <bui-input type="number" step="2" value="2"></bui-input> `);
  ...
  describe('when using spellcheck', () => {
    ...
    it('should enable spellcheck when set to "true"', async () => {
      const el = await fixture<Input>(html` <bui-input spellcheck="true"></bui-input> `);
      const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
      expect(input.getAttribute('spellcheck')).to.equal('true');
      expect(input.spellcheck).to.be.true;
    });
    ...
    it('should disable spellcheck when set to "false"', async () => {
      const el = await fixture<Input>(html` <bui-input spellcheck="false"></bui-input> `);
      const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
    ...
    it('should submit with the correct form when the form attribute changes', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <bui-input form="f1" name="a" value="1"></bui-input>
        </div>
      `);
      const form = el.querySelector<HTMLFormElement>('#f2')!;
      const input = document.querySelector('bui-input')!;
  ...
  describe('when using the getFormControls() function', () => {
    it('should return both native and BuckeyeUI form controls in the correct DOM order', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          <input type="text" name="a" value="1" form="f1" />
          <bui-input type="text" name="b" value="2" form="f1"></bui-input>
          <form id="f1">
            <input type="hidden" name="c" value="3" />
            <input type="text" name="d" value="4" />
            <bui-input name="e" value="5"></bui-input>
            <textarea name="f">6</textarea>
            <bui-textarea name="g" value="7"></bui-textarea>
            <bui-checkbox name="h" value="8"></bui-checkbox>
          </form>
          <input type="text" name="i" value="9" form="f1" />
          <bui-input type="text" name="j" value="10" form="f1"></bui-input>
        </div>
      `);
  ...
  runFormControlBaseTests('bui-input');
});
