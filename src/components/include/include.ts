 ...
 * @since 2.0
 *
 * @event bui-load - Emitted when the included file is loaded.
 * @event {{ status: number }} bui-error - Emitted when the included file fails to load due to an error.
 */
@customElement('bui-include')
