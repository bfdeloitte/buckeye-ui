 ...
 * @slot expand-icon - Optional expand icon to use instead of the default. Works best with `<bui-icon>`.
 * @slot collapse-icon - Optional collapse icon to use instead of the default. Works best with `<bui-icon>`.
 *
 * @event bui-show - Emitted when the details opens.
 * @event bui-after-show - Emitted after the details opens and all animations are complete.
 * @event bui-hide - Emitted when the details closes.
 * @event bui-after-hide - Emitted after the details closes and all animations are complete.
 *
