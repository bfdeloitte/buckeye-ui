...
export default css`
  ...
  .drawer--fixed {
    position: fixed;
    z-index: var(--bui-z-index-drawer);
  }
  ...
  .drawer__header-actions bui-icon-button,
  .drawer__header-actions ::slotted(bui-icon-button) {
    flex: 0 0 auto;
    display: flex;
    align-items: center;
  ...
  .drawer__footer ::slotted(bui-button:not(:last-of-type)) {
