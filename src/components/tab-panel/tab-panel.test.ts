...
describe('<bui-tab-panel>', () => {
  it('passes accessibility test', async () => {
    const el = await fixture<TabPanel>(html` <bui-tab-panel>Test</bui-tab-panel> `);
  ...
  it('default properties', async () => {
    ...
    expect(el.id).to.equal('bui-tab-panel-2');
  ...
  it('passed id should be used', async () => {
    const el = await fixture<TabPanel>(html` <bui-tab-panel id="test-id">Test</bui-tab-panel> `);
