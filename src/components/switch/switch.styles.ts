...
export default css`
  ...
  :host([size='small']) {
    --height: var(--bui-toggle-size-small);
    --thumb-size: calc(var(--bui-toggle-size-small) + 4px);
  ...
  :host([size='medium']) {
    --height: var(--bui-toggle-size-medium);
    --thumb-size: calc(var(--bui-toggle-size-medium) + 4px);
    --width: calc(var(--height) * 2);
  ...
  :host([size='large']) {
    --height: var(--bui-toggle-size-large);
    --thumb-size: calc(var(--bui-toggle-size-large) + 4px);
    --width: calc(var(--height) * 2);
  ...
  .switch__control {
    ...
    width: var(--width);
    height: var(--height);
    background-color: var(--bui-color-neutral-400);
    border: solid var(--bui-input-border-width) var(--bui-color-neutral-400);
  ...
  .switch__control .switch__thumb {
    ...
    transition: var(--bui-transition-fast) translate ease, var(--bui-transition-fast) background-color,
      var(--bui-transition-fast) border-color, var(--bui-transition-fast) box-shadow;
  }
  ...
  .switch:not(.switch--checked):not(.switch--disabled) .switch__control:hover {
    background-color: var(--bui-color-neutral-400);
    border-color: var(--bui-color-neutral-400);
  }
