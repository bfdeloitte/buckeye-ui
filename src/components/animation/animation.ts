 ...
 * @documentation https://buckeyeui.com/components/animation
 * @status stable
 * @since 2.0
 *
 * @event bui-cancel - Emitted when the animation is canceled.
 * @event bui-finish - Emitted when the animation finishes.
 * @event bui-start - Emitted when the animation starts or restarts.
 *
...
export default class Animation extends BuckeyeElement {
  ...
  private handleAnimationFinish() {
    ...
    this.emit('bui-finish');
  }

  private handleAnimationCancel() {
    this.play = false;
    this.hasStarted = false;
    this.emit('bui-cancel');
  }
