...
describe('<bui-tree>', () => {
  ...
  beforeEach(async () => {
    el = await fixture(html`
      <bui-tree>
        <bui-tree-item>Node 1</bui-tree-item>
        <bui-tree-item>Node 2</bui-tree-item>
        <bui-tree-item id="expandable">
          Parent Node
          <bui-tree-item>Child Node 1</bui-tree-item>
          <bui-tree-item>
            Child Node 2
            <bui-tree-item>Child Node 2 - 1</bui-tree-item>
            <bui-tree-item>Child Node 2 - 2</bui-tree-item>
          </bui-tree-item>
        </bui-tree-item>
        <bui-tree-item>Node 3</bui-tree-item>
      </bui-tree>
    `);
  });
  ...
  it('should not focus collapsed nodes', async () => {
    // Arrange
    const parentNode = el.children[2] as TreeItem;
    const childNode = parentNode.children[1] as TreeItem;
  ...
  describe('when a custom expanded/collapsed icon is provided', () => {
    ...
    it('should append a clone of the icon in the proper slot of the tree item', async () => {
      ...
      // Act
      const treeItems = [...el.querySelectorAll('bui-tree-item')];
  ...
  describe('Keyboard navigation', () => {
    ...
    describe('when Home is pressed', () => {
      it('should move the focus to the first tree item in the tree', async () => {
        // Arrange
        const parentNode = el.children[3] as TreeItem;
        parentNode.focus();
        await el.updateComplete;
    ...
    describe('when End is pressed', () => {
      it('should move the focus to the last tree item in the tree', async () => {
        // Arrange
        const parentNode = el.children[0] as TreeItem;
        parentNode.focus();
        await el.updateComplete;
    ...
    describe('when Enter is pressed', () => {
      describe('and selection is "single"', () => {
        it('should select only one tree item', async () => {
          // Arrange
          el.selection = 'single';
          const node = el.children[1] as TreeItem;
          node.focus();
          await el.updateComplete;
      ...
      describe('and selection is "leaf"', () => {
        it('should select only one tree item', async () => {
          // Arrange
          el.selection = 'leaf';
          const node = el.children[0] as TreeItem;
          node.focus();
          await el.updateComplete;
  ...
  describe('Interactions', () => {
    ...
    describe('when the user clicks the expand button', () => {
      it('should expand the tree item', async () => {
        ...
        const node = el.children[2] as TreeItem;
    ...
    describe('when the user clicks on a tree item', () => {
      describe('and selection is "single"', () => {
        it('should select only one tree item', async () => {
          // Arrange
          el.selection = 'single';
          const node0 = el.children[0] as TreeItem;
          const node1 = el.children[1] as TreeItem;
      ...
      describe('and selection is "multiple"', () => {
        ...
        it('should set the indeterminate state to tree items if a child is selected', async () => {
          ...
          const parentNode = el.children[2] as TreeItem;
          const childNode = parentNode.children[0] as TreeItem;
    ...
    describe('when selection is "single"', () => {
      describe('and user clicks on same item twice', () => {
        it('should emit `bui-selection-change` event once', async () => {
          // Arrange
          el.selection = 'single';
          await el.updateComplete;

          const selectedChangeSpy = sinon.spy();
          el.addEventListener('bui-selection-change', selectedChangeSpy);
  ...
  describe('when selection is "leaf"', () => {
    ...
    describe('and user clicks on expandable item', () => {
      it('should not emit `bui-selection-change` event', async () => {
        // Arrange
        el.selection = 'leaf';
        await el.updateComplete;
        ...
        const node = el.querySelector<TreeItem>('#expandable')!;
  ...
  describe('when selection is "multiple"', () => {
    describe('and user clicks on same item twice', () => {
      it('should emit `bui-selection-change` event twice', async () => {
        // Arrange
        el.selection = 'multiple';
        await el.updateComplete;
      ...
      describe('and a parent node is selected', () => {
        it('should select all the nested children', async () => {
          ...
          const tree = await fixture<Tree>(html`
            <bui-tree selection="multiple">
              <bui-tree-item selected>
                Parent Node
                <bui-tree-item selected>Child Node 1</bui-tree-item>
                <bui-tree-item>
                  Child Node 2
                  <bui-tree-item>Child Node 2 - 1</bui-tree-item>
                  <bui-tree-item>Child Node 2 - 2</bui-tree-item>
          ...
          `);
          const treeItems = Array.from<TreeItem>(tree.querySelectorAll('bui-tree-item'));
