...
describe('<bui-textarea>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<Textarea>(html` <bui-textarea label="Name"></bui-textarea> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<Textarea>(html` <bui-textarea></bui-textarea> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<Textarea>(html` <bui-textarea title="Test"></bui-textarea> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<Textarea>(html` <bui-textarea disabled></bui-textarea> `);
  ...
  describe('when the value changes', () => {
    it('should emit bui-change and bui-input when the user types in the textarea', async () => {
      const el = await fixture<Textarea>(html` <bui-textarea></bui-textarea> `);
    ...
    it('should not emit bui-change or bui-input when calling setRangeText()', async () => {
      const el = await fixture<Textarea>(html` <bui-textarea value="hi there"></bui-textarea> `);
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<Textarea>(html` <bui-textarea required></bui-textarea> `);

      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and after removing disabled ', async () => {
      const el = await fixture<Textarea>(html` <bui-textarea disabled required></bui-textarea> `);
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<Textarea>(html` <bui-textarea required value="a"></bui-textarea> `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><bui-textarea required></bui-textarea></form> `);
      const textarea = el.querySelector<Textarea>('bui-textarea')!;
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(
        html` <form><bui-textarea name="a" value="1"></bui-textarea></form> `
      );
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const textarea = await fixture<HTMLFormElement>(html` <bui-textarea></bui-textarea> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <bui-textarea form="f" name="a" value="1"></bui-textarea>
        </div>
      `);
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <bui-textarea name="a" value="test"></bui-textarea>
          <bui-button type="reset">Reset</bui-button>
        </form>
      `);
      const button = form.querySelector('bui-button')!;
      const textarea = form.querySelector('bui-textarea')!;
      textarea.value = '1234';
  ...
  describe('when using spellcheck', () => {
    ...
    it('should enable spellcheck when set to "true"', async () => {
      const el = await fixture<Textarea>(html` <bui-textarea spellcheck="true"></bui-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
      expect(textarea.getAttribute('spellcheck')).to.equal('true');
      expect(textarea.spellcheck).to.be.true;
    });
    ...
    it('should disable spellcheck when set to "false"', async () => {
      const el = await fixture<Textarea>(html` <bui-textarea spellcheck="false"></bui-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
  ...
  runFormControlBaseTests('bui-textarea');
});
