...
var carousel_styles_default = i`
  ...
  :host {
    --slide-gap: var(--bui-spacing-medium, 1rem);
    --aspect-ratio: 16 / 9;
    --scroll-hint: 0px;
  ...
  :host([vertical]) ::slotted(bui-carousel-item) {
    height: 100%;
  }
  ...
  .carousel__navigation-button {
    ...
    cursor: pointer;
    transition: var(--bui-transition-medium) color;
    appearance: none;
  }
  ...
  .carousel__pagination-item {
    ...
    width: var(--bui-spacing-small);
    height: var(--bui-spacing-small);
    background-color: var(--bui-color-neutral-300);
    padding: 0;
    margin: 0;
  }
