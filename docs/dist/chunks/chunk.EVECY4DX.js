...
} from "./chunk.L22AVNCE.js";
import {
  ScrollController
} from "./chunk.MXKKAVOJ.js";
import {
  CarouselItem
} from "./chunk.5GWOAZOC.js";
import {
  AutoplayController
...
var Carousel = class extends BuckeyeElement {
  constructor() {
    super(...arguments);
    this.loop = false;
    ...
    this.slides = this.getElementsByTagName("bui-carousel-item");
  ...
  handleSlotChange(mutations) {
    const needsInitialization = mutations.some(
      (mutation) => [...mutation.addedNodes, ...mutation.removedNodes].some(
        (node) => CarouselItem.isCarouselItem(node) && !node.hasAttribute("data-clone")
      )
    );
  ...
  render() {
    ...
    return x`
      ...
      "carousel__navigation-button--disabled": !prevEnabled
                ...
                >
                  <slot name="previous-icon">
                    <bui-icon library="system" name="${isLtr ? "chevron-left" : "chevron-right"}"></bui-icon>
                  </slot>
                </button>
      ...
      "carousel__navigation-button--disabled": !nextEnabled
                ...
                >
                  <slot name="next-icon">
                    <bui-icon library="system" name="${isLtr ? "chevron-right" : "chevron-left"}"></bui-icon>
                  </slot>
                </button>
              </div>
            ` : ""}
...
Carousel.styles = carousel_styles_default;
__decorateClass([
  e2({ type: Boolean, reflect: true })
], Carousel.prototype, "loop", 2);
__decorateClass([
  e2({ type: Boolean, reflect: true })
], Carousel.prototype, "navigation", 2);
__decorateClass([
  e2({ type: Boolean, reflect: true })
], Carousel.prototype, "pagination", 2);
__decorateClass([
  e2({ type: Boolean, reflect: true })
], Carousel.prototype, "autoplay", 2);
__decorateClass([
  e2({ type: Number, attribute: "autoplay-interval" })
], Carousel.prototype, "autoplayInterval", 2);
__decorateClass([
  e2({ type: Number, attribute: "slides-per-page" })
], Carousel.prototype, "slidesPerPage", 2);
__decorateClass([
  e2({ type: Number, attribute: "slides-per-move" })
], Carousel.prototype, "slidesPerMove", 2);
__decorateClass([
  e2()
], Carousel.prototype, "orientation", 2);
__decorateClass([
  e2({ type: Boolean, reflect: true, attribute: "mouse-dragging" })
], Carousel.prototype, "mouseDragging", 2);
__decorateClass([
  i("slot:not([name])")
], Carousel.prototype, "defaultSlot", 2);
__decorateClass([
  i(".carousel__slides")
], Carousel.prototype, "scrollContainer", 2);
__decorateClass([
  i(".carousel__pagination")
], Carousel.prototype, "paginationContainer", 2);
__decorateClass([
  t()
], Carousel.prototype, "activeSlide", 2);
__decorateClass([
  watch("loop", { waitUntilFirstUpdate: true }),
  watch("slidesPerPage", { waitUntilFirstUpdate: true })
], Carousel.prototype, "initializeSlides", 1);
__decorateClass([
  watch("activeSlide")
], Carousel.prototype, "handelSlideChange", 1);
__decorateClass([
  watch("slidesPerMove")
], Carousel.prototype, "handleSlidesPerMoveChange", 1);
__decorateClass([
  watch("autoplay")
], Carousel.prototype, "handleAutoplayChange", 1);
__decorateClass([
  watch("mouseDragging")
], Carousel.prototype, "handleMouseDraggingChange", 1);
