...
var toastStack = Object.assign(document.createElement("div"), { className: "bui-toast-stack" });
var Alert = class extends BuckeyeElement {
  constructor() {
    super(...arguments);
...
Alert.styles = alert_styles_default;
__decorateClass([
  i('[part~="base"]')
