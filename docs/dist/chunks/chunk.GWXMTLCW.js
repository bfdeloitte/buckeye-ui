...
var QrCode = class extends BuckeyeElement {
  constructor() {
    super(...arguments);
    this.value = "";
    this.label = "";
...
QrCode.styles = qr_code_styles_default;
__decorateClass([
  i("canvas")
], QrCode.prototype, "canvas", 2);
__decorateClass([
  e2()
], QrCode.prototype, "value", 2);
__decorateClass([
  e2()
], QrCode.prototype, "label", 2);
__decorateClass([
  e2({ type: Number })
], QrCode.prototype, "size", 2);
__decorateClass([
  e2()
], QrCode.prototype, "fill", 2);
__decorateClass([
  e2()
], QrCode.prototype, "background", 2);
__decorateClass([
  e2({ type: Number })
], QrCode.prototype, "radius", 2);
__decorateClass([
  e2({ attribute: "error-correction" })
], QrCode.prototype, "errorCorrection", 2);
__decorateClass([
  watch(["background", "errorCorrection", "fill", "radius", "size", "value"])
], QrCode.prototype, "generate", 1);
QrCode = __decorateClass([
  e("bui-qr-code")
], QrCode);
