...
var Tree = class extends BuckeyeElement {
  constructor() {
    super(...arguments);
  ...
  getAllTreeItems() {
    return [...this.querySelectorAll("bui-tree-item")];
  }
  focusItem(item) {
  ...
  async handleSelectionChange() {
    ...
    if (isSelectionMultiple) {
      await this.updateComplete;
      [...this.querySelectorAll(":scope > bui-tree-item")].forEach(
...
Tree.styles = tree_styles_default;
__decorateClass([
  i("slot:not([name])")
