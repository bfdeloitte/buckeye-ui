...
<script setup>
  import { ref } from 'vue';
  import 'iop-ui/dist/components/qr-code/qr-code.js';
...
?> Are you using BuckeyeUI with Vue? [Help us improve this page!](https://github.com/shoelace-style/shoelace/blob/next/docs/frameworks/vue.md)
