...
import { SlCarousel, SlCarouselItem, SlDivider, SlSwitch } from 'iop-ui/dist/react';
...
```jsx react
import { useState } from 'react';
import { SlCarousel, SlCarouselItem, SlDivider, SlSelect, SlOption } from 'iop-ui/dist/react';
...
```jsx react
import { useState } from 'react';
import { SlCarousel, SlCarouselItem, SlDivider, SlRange } from 'iop-ui/dist/react';
