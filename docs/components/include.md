...
```html preview
<sl-include src="https://buckeyeui.com/assets/examples/include.html"></sl-include>
```

```jsx react
import { SlInclude } from 'buckeye-ui/dist/react';

const App = () => <SlInclude src="https://buckeyeui.com/assets/examples/include.html" />;
```
