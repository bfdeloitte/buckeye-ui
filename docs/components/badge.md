...
```jsx react
import { SlBadge } from 'iop-ui/dist/react';
...
```jsx react
import { SlBadge, SlButton } from 'iop-ui/dist/react';
...
```jsx react
import { SlBadge, SlButton, SlMenu, SlMenuItem, SlMenuLabel } from 'iop-ui/dist/react';
