...
```jsx react
import { SlSplitPanel } from 'iop-ui/dist/react';
...
import { SlSplitPanel, SlSelect, SlMenuItem } from 'iop-ui/dist/react';
...
```jsx react
import { SlSplitPanel, SlIcon } from 'iop-ui/dist/react';
