...
```jsx react
import { SlButton, SlIcon } from 'buckeye-ui/dist/react';
...
<sl-button href="/assets/images/buckeyeui.png" download="buckeyeui.png">Download</sl-button>
...
const App = () => (
  <>
    ...
    <SlButton href="/assets/images/buckeyeui.png" download="buckeyeui.png">
      Download
    </SlButton>
