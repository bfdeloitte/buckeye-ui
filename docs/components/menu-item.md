...
```jsx react
import { SlDivider, SlIcon, SlMenu, SlMenuItem } from 'iop-ui/dist/react';
...
```jsx react
import { SlMenu, SlMenuItem } from 'iop-ui/dist/react';
...
```jsx react
import { SlBadge, SlDivider, SlIcon, SlMenu, SlMenuItem } from 'iop-ui/dist/react';
